...
import { FetchProjects } from "../api/TwetchGraph";
...
export default function Problems(props) {
  ...
  const fetchMore = () => {
    FetchProjects(filter, orderBy, offset).then((res) => {
      //console.log(res);
  ...
  return (
    ...
    >
      {smDown ? null : <LeftPane currentTab="Problems" />}
      <div
        style={{
          flex: 2,
          width: "100%",
      ...
      >
        ...
        >
          <div style={{ cursor: "pointer" }} onClick={scrollTop}>
            {smUp ? null : <AppBar currentTab="Problems" />}
            {!smUp ? null : (
              <div
                style={{
                  height: "81px",
              ...
              >
                ...
                >
                  ...
                  >
                    <span role="img" arial-label="thinking">
                      🤔
                    </span>{" "}
                    Problems{" "}
                    <span role="img" arial-label="thinking">
